...
RSpec.describe "lunch_specials/new", type: :view do
  before(:each) do
    assign(:lunch_special, LunchSpecial.new(
      :title => "MyString",
  ...
  it "renders new lunch_special form" do
    render

    assert_select "form[action=?][method=?]", lunch_specials_path, "post" do
